...
export function Console({ consoleOutputs, setConsoleOutputs }: ConsoleProps) {
  ...
  return consoleOutputs.length > 0 ? (
    <>
      ...
      <div
        className={cn(
          "fixed bottom-0 z-40 flex w-full flex-col overflow-x-hidden overflow-y-scroll border-zinc-700 border-t bg-zinc-900",
          {
        ...
        style={{ height }}
      >
        <div className="sticky top-0 z-50 flex h-fit w-full flex-row items-center justify-between border-zinc-700 border-b bg-muted px-2 py-1">
          <div className="flex flex-row items-center gap-3 pl-2 text-sm text-zinc-50">
          ...
          <Button
            className="size-fit p-1 hover:bg-zinc-700"
        ...
        <div>
          {consoleOutputs.map((consoleOutput, index) => (
            <div
              className="flex flex-row border-zinc-700 border-b bg-zinc-900 px-4 py-2 font-mono text-sm"
            ...
            >
              ...
              {["in_progress", "loading_packages"].includes(
                ...
                <div className="flex w-full flex-col gap-2 overflow-x-scroll text-zinc-50">
