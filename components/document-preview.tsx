...
const LoadingSkeleton = ({ artifactKind }: { artifactKind: ArtifactKind }) => (
  <div className="w-full max-w-[450px]">
    <div className="flex h-[57px] flex-row items-center justify-between gap-2 rounded-t-2xl border border-b-0 border-zinc-700 bg-muted p-4">
    ...
    {artifactKind === "image" ? (
      <div className="overflow-y-scroll rounded-b-2xl border border-t-0 border-zinc-700 bg-muted">
        <div className="h-[257px] w-full animate-pulse bg-muted-foreground/20" />
      </div>
    ) : (
      <div className="overflow-y-scroll rounded-b-2xl border border-t-0 border-zinc-700 bg-muted p-8 pt-4">
  ...
  return (
    ...
    >
      <div className="flex w-full items-center justify-end p-4">
        <div className="absolute top-[13px] right-[9px] rounded-md p-2 hover:bg-zinc-700">
          <FullscreenIcon />
        </div>
      </div>
    </div>
...
const PureDocumentHeader = ({
  ...
  <div className="flex flex-row items-start justify-between gap-2 rounded-t-2xl border border-b-0 border-zinc-700 bg-muted p-4 sm:items-center">
...
const DocumentContent = ({ document }: { document: Document }) => {
  ...
  const containerClassName = cn(
    "h-[257px] overflow-y-scroll rounded-b-2xl border border-t-0 border-zinc-700 bg-muted",
    {
